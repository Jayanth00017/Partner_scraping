...
def cfi_esg():
    ...
    course_links=[]
    specialization_url='https://courses.corporatefinanceinstitute.com/collections?category=all-esg-courses'
    base_url = 'https://courses.corporatefinanceinstitute.com'
    headers = {
        'User-Agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.107 Safari/537.36'
    }

    r=requests.get(specialization_url,headers=headers)
    ...
    for url in course_links:
        ...
        #print(pricing_type)
          ...
          df = df.transpose()
          df.to_csv("cfi_esg.csv", index=False)
