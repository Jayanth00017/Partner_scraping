...
urlArray.append("https://www.futurelearn.com/microcredentials/itil-4")
urlArray.append("https://www.futurelearn.com/microcredentials/prince2")
urlArray.append("https://www.futurelearn.com/microcredentials/prince-2-practitioner")
...
df.to_csv('micro_no_inst.csv', index=True, header=True)