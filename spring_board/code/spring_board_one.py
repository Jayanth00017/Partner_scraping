...
import pandas as pd
urlArray = []
urlArray.append("https://www.springboard.com/courses/ui-ux-design-career-track/")
urlArray.append("https://www.springboard.com/courses/data-engineering-career-track/")
def process_description(soupObject):
    desc = ""
    descrip = soupObject.find('div', attrs={'class':'styles__Description-sku7kn-2 huFBKk'}).findNext('p')
    for des in descrip:
...
df.to_csv('spring_board_1.csv', index=True, header=True)
